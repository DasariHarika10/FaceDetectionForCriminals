...
public class FaceMenu extends JFrame implements ActionListener {
	...
	ImageIcon i = new ImageIcon(getClass().getResource("Icons\\New.gif"));
	JMenuItem fileNew = new JMenuItem("New", i);

	ImageIcon j = new ImageIcon(getClass().getResource("Icons\\Show Details.gif"));
	JMenuItem fileShow = new JMenuItem("Show details", j);
	JMenuItem fileExit = new JMenuItem("Exit");

	ImageIcon Co1 = new ImageIcon(getClass().getResource("Icons\\Construct.gif"));
	JMenuItem editClip = new JMenuItem("Clipping", Co1);

	ImageIcon Up = new ImageIcon(getClass().getResource("Icons\\Update.gif"));
	JMenuItem editUpdate = new JMenuItem("Update details", Up);

	ImageIcon Co = new ImageIcon(getClass().getResource("Icons\\Construct.gif"));
	JMenuItem identificationConstruct = new JMenuItem("Construct Face", Co);

	ImageIcon Fi = new ImageIcon(getClass().getResource("Icons\\Find.gif"));
	JMenuItem identificationFind = new JMenuItem("Find Face", Fi);

	ImageIcon pr = new ImageIcon(getClass().getResource("Icons\\About.gif"));
	...
	public FaceMenu() {
		...
		b1 = new JButton(new ImageIcon(getClass().getResource("Icons\\New.gif")));
		b1.setToolTipText("New");

		b2 = new JButton(new ImageIcon(getClass().getResource("Icons\\Show Details.gif")));
		b2.setToolTipText("ShowsDetails");

		b3 = new JButton(new ImageIcon(getClass().getResource("Icons\\Construct.gif")));
		b3.setToolTipText("Construct Image");

		b4 = new JButton(new ImageIcon(getClass().getResource("Icons\\Find.gif")));
