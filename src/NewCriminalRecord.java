	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (b == b2) {
			try {
				...
				String str = "insert into face(cid,fname,lname,aname,dob,age,gender,address,city,state,arresteddate,crimein,photo) values("
						+ cid + ",'" + firstname + "','" + lastname + "','" + aliasname + "',STR_TO_DATE('" + dob + "-"
						+ mob + "-" + yob + "','%d-%m-%Y')," + age + ",'" + gender + "','" + address + "','" + city
						+ "','" + state + "','" + arresteddate + "','" + crimeinvolved + "','" + photo + "')";
