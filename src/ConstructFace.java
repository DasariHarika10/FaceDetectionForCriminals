...
class Construct extends JFrame implements ActionListener {
	...
	Construct() {
		...
		try {
			...
			con = DriverManager.getConnection(d1.host, d1.username, d1.password);
			...
			while (rs.next()) {
				...
				if (selcrimid.equalsIgnoreCase("Select Hair"))
					JOptionPane.showMessageDialog(this, "Select the hair of the Criminal to construct the Photo",
							"constructing Photograph", JOptionPane.ERROR_MESSAGE);
				FileInputStream hairfin = new FileInputStream(getClass().getResource("Clips\\hair\\hair" + selcrimid + ".gif").getFile());
				...
				FileInputStream fhfin = new FileInputStream(getClass().getResource("Clips\\forehead\\forehead" + selcrimid + ".gif").getFile());
				...
				FileInputStream eyesfin = new FileInputStream(getClass().getResource("Clips\\eyes\\eyes" + selcrimid + ".gif").getFile());
				...
				FileInputStream nosefin = new FileInputStream(getClass().getResource("Clips\\nose\\nose" + selcrimid + ".gif").getFile());
				...
				FileInputStream lipsfin = new FileInputStream(getClass().getResource("Clips\\lips\\lips" + selcrimid + ".gif").getFile());
				...
				FileInputStream chinfin = new FileInputStream(getClass().getResource("Clips\\chin\\chin" + selcrimid + ".gif").getFile());
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == cHair) {
			/*
			 * ImageIcon stt=(ImageIcon)cHair.getSelectedItem(); ht1=stt.getIconHeight();
			 * int wt1=stt.getIconWidth(); lHair1.setBounds(400,200,wt1,ht1); ha1=200+ht1;
			 * lHair1.setIcon(stt); hr=cHair.getSelectedIndex();
			 */
			...
			lHair1.setBounds(new Rectangle((int) recthair.getX(), (int) recthair.getY(), (int) recthair.getWidth(),
					finalhairht));
		...
		if (ae.getSource() == cForehead) {
			 ...
			 * ht2=stt1.getIconHeight(); int wt2=stt1.getIconWidth();
			 * lForehead1.setBounds(400,ha1,wt2,ht2); ha2=ha1+ht2; lForehead1.setIcon(stt1);
			...
			Rectangle recthair = lHair1.getBounds();
			lForehead1.setBounds(new Rectangle((int) rectfh.getX(), (int) recthair.getY() + finalhairht,
					(int) rectfh.getWidth(), finalfhht));
		...
		if (ae.getSource() == cEyes) {
			 ...
			 * ht3=sttEye.getIconHeight(); int wt3=sttEye.getIconWidth();
			 * lEyes1.setBounds(400,ha2,wt3,ht3); ha3=ha2+ht3; lEyes1.setIcon(sttEye);
			...
			lEyes1.setBounds(new Rectangle((int) rectfh.getX(), (int) recthair.getY() + finalhairht + finalfhht,
					(int) rectfh.getWidth(), finaleyesht));
		...
		if (ae.getSource() == cNose) {
			 ...
			 * ht4=sttNose.getIconHeight(); int wt4=sttNose.getIconWidth();
			 * lNose1.setBounds(400,ha3,wt4,ht4); ha4=ha3+ht4; lNose1.setIcon(sttNose);
			...
			Rectangle recteyes = lEyes1.getBounds();
			lNose1.setBounds(
					new Rectangle((int) rectfh.getX(), (int) recthair.getY() + finalhairht + finalfhht + finaleyesht,
							(int) rectfh.getWidth(), finalnoseht));
		...
		if (ae.getSource() == cLips) {
			 ...
			 * ht5=sttLips.getIconHeight(); int wt5=sttLips.getIconWidth();
			 * lLips1.setBounds(400,ha4,wt5,ht5); ha5=ha4+ht5; lLips1.setIcon(sttLips);
			...
			lLips1.setBounds(new Rectangle((int) rectfh.getX(),
					(int) recthair.getY() + finalhairht + finalfhht + finaleyesht + finalnoseht,
					(int) rectfh.getWidth(), finallipsht));
		...
		if (ae.getSource() == cChin) {
			 ...
			 * ht6=sttChin.getIconHeight(); int wt6=sttChin.getIconWidth();
			 * lChin1.setBounds(400,ha5,wt6,ht6); lChin1.setIcon(sttChin);
			...
			lChin1.setBounds(new Rectangle((int) rectfh.getX(),
					(int) recthair.getY() + finalhairht + finalfhht + finaleyesht + finalnoseht + finallipsht,
					(int) rectfh.getWidth(), finalchinht));
			lChin1.setIcon(selchinicn);
		}
		if (ae.getSource() == bSave) {
			Rectangle recthair = lHair1.getBounds();
			lHair1.setBounds(new Rectangle((int) recthair.getX(), (int) recthair.getY(), (int) recthair.getWidth(),
					(int) recthair.getHeight()));

			Rectangle rectfh = lForehead1.getBounds();
			nextheight = (int) recthair.getY() + (int) recthair.getHeight();
			lForehead1.setBounds(
					new Rectangle((int) rectfh.getX(), nextheight, (int) rectfh.getWidth(), (int) rectfh.getHeight()));

			Rectangle recteyes = lEyes1.getBounds();
			nextheight = nextheight + (int) rectfh.getHeight();
			lEyes1.setBounds(new Rectangle((int) recteyes.getX(), nextheight, (int) recteyes.getWidth(),
					(int) recteyes.getHeight()));

			Rectangle rectnose = lNose1.getBounds();
			nextheight = nextheight + (int) recteyes.getHeight();
			lNose1.setBounds(new Rectangle((int) rectnose.getX(), nextheight, (int) rectnose.getWidth(),
					(int) rectnose.getHeight()));

			Rectangle rectlips = lLips1.getBounds();
			nextheight = nextheight + (int) rectnose.getHeight();
			lLips1.setBounds(new Rectangle((int) rectlips.getX(), nextheight, (int) rectlips.getWidth(),
					(int) rectlips.getHeight()));

			Rectangle rectchin = lChin1.getBounds();
			nextheight = nextheight + (int) rectlips.getHeight();
			lChin.setBounds(new Rectangle((int) rectchin.getX(), nextheight, (int) rectchin.getWidth(),
			...
			try {
				...
				if (rs.next()) {
					...
					st.executeUpdate("insert into face_suspectphoto(crimeid, suspectphoto, photo_height) values(" + crid
							+ ",'suspect" + crid + ".gif'," + nextheight + ")");
					for (int i = 0; i < 6; i++) {
						st.executeUpdate(
								"insert into face_suspects(crimeid, cid) values(" + crid + "," + cids[i] + ")");
					}
					JOptionPane.showMessageDialog(this,
							"Photo saved successfully for the Crime Identification Number: " + crid, "Crime Status",
	...
	public void writePhoto(int a[], int crid) {
		try {
			FileOutputStream suspectfout = new FileOutputStream(getClass().getResource("Suspects\\suspect" + crid + ".gif").getFile());
			DataOutputStream suspectdout = new DataOutputStream(suspectfout);

			FileInputStream hairfin = new FileInputStream(getClass().getResource("Clips\\hair\\hair" + cids[0] + ".gif").getFile());
			DataInputStream hairdin = new DataInputStream(hairfin);
			while (hairfin.available() > 0) {
			...
			FileInputStream fhfin = new FileInputStream(getClass().getResource("Clips\\forehead\\forehead" + cids[1] + ".gif").getFile());
			DataInputStream fhdin = new DataInputStream(fhfin);
			while (fhfin.available() > 0) {
			...
			FileInputStream eyesfin = new FileInputStream(getClass().getResource("Clips\\eyes\\eyes" + cids[2] + ".gif").getFile());
			DataInputStream eyesdin = new DataInputStream(eyesfin);
			while (eyesfin.available() > 0) {
			...
			FileInputStream lipsfin = new FileInputStream(getClass().getResource("Clips\\lips\\lips" + cids[4] + ".gif").getFile());
			DataInputStream lipsdin = new DataInputStream(lipsfin);
			while (lipsfin.available() > 0) {
			...
			FileInputStream chinfin = new FileInputStream(getClass().getResource("Clips\\chin\\chin" + cids[5] + ".gif").getFile());
			DataInputStream chindin = new DataInputStream(chinfin);
			while (chinfin.available() > 0) {
